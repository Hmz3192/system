...
<div class="public-ifame mt20">
    <div class="content">
        ...
        <div class="public-ifame-content">
            <iframe name="content" src="${pageContext.request.contextPath }/jsp/main.jsp" frameborder="0" id="mainframe" scrolling="yes" marginheight="0" marginwidth="0" width="100%" style="height: 700px;"></iframe>
        </div>
    </div>
</div>
