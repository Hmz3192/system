...
<head>
    ...
    <style type="text/css">
        ...
        body{behavior:url("${pageContext.request.contextPath}/static/css/hover_htc.htc");font-family:"Microsoft YaHei",宋体; color:#333;}/*hover*/
        ...
        .l_button,.r_button{background:url(${pageContext.request.contextPath}/static/images/login_button.png) no-repeat; width:118px; height:39px; border:none; cursor:pointer; display:block; float:left; text-indent:-9000px}
        ...
        .onShow,.onFocus,.onError,.onCorrect,.onLoad{background:url(${pageContext.request.contextPath}/static/images/reg_bg.png) no-repeat 3000px 3000px;padding-left:30px; font-size: 12px; height:25px; width:124px; display:inline-block; line-height:25px; vertical-align:middle; overflow:hidden; margin-left:6px}
        ...
        .id input,.pw input,.in_id,.in_mo,.reg_input,.reg_input_pic{_behavior:url(${pageContext.request.contextPath}/static/js/Round_htc.htc);-moz-border-radius:4px;-webkit-border-radius:4px;border-radius:4px; height:25px;}
        .user_button a,.pay_but{_behavior:url(${pageContext.request.contextPath}/static/js/Round_htc.htc);-moz-border-radius:100px;-webkit-border-radius:100px;border-radius:100px;}
    ...
    <script src="${pageContext.request.contextPath}/static/js/jquery-1.2.6.min.js" type=text/javascript></script>
    <script src="${pageContext.request.contextPath}/static/js/formValidator_min.js" type="text/javascript" charset="UTF-8"></script>
    <script src="${pageContext.request.contextPath}/static/js/formValidatorRegex.js" type="text/javascript" charset="UTF-8"></script>
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $("#username").formValidator({onshow:"5-10个字符",onfocus:"5-10个字符",oncorrect:"该用户名可以注册"}).inputValidator({min:5,max:10,onerror:"输入有误"}).regexValidator({regexp:"username",datatype:"enum",onerror:"格式有误"});
            ...
            $("#t_RePass").formValidator({onshow:"请再次输入密码",onfocus:"请再次输入密码",oncorrect:"密码一致"}).inputValidator({min:6,empty:{leftempty:false,rightempty:false,emptyerror:"输入有误"},onerror:"输入有误"}).compareValidator({desid:"password",operateor:"=",onerror:"密码不一致"});
    ...
    <form action="" method="post" name="form1" id="form1">
        <dl>
            ...
            <dd>
                ...
                <input class="reg_input" name="username" id="username" onblur="checkusername(this.value);" type="text" />
                <span id="t_UserNameTip" class="onshow"></span>
            </dd>
           <%-- <dd>
                <span class="title">昵称：</span>
                <input class="reg_input" name="iptNickName" id="iptNickName" onblur="checkNickName(this.value)" type="text" />
                <span id="iptNickNameTip" class="onshow"></span>
            </dd>
            <dd>
                <span class="title">性别：</span>
                <input type="radio" id="Sex_Man" name="rb_Sex" value="0" checked="CHECKED" />
                <label for="Sex_Man"> 帅哥</label>
                <input type="radio" id="Sex_Woman" name="rb_Sex" value="0" />
                <label for="Sex_Woman"> 美女</label>　
        ...
        <dl>
            ...
            <dd>
                ...
                <input class="reg_input" onblur="return checkpasswd(this);" id="password" name="password" type="password"/>
                <span id="t_UserPassTip" class="onshow">
                </span>
            </dd>
            <dd>
                <span class="title">确认登录密码：</span>
                <input onblur="checkdoublepassword();" class="reg_input" type="password" id="t_RePass" name="t_RePass"/>
                <span id="t_RePassTip" class="onshow">
                </span>
            </dd>
            ...
            <dd><span class="title">验证码：</span><input id="t_CheckCode" class="reg_input_pic" name="t_CheckCode" type="text" maxlength="4" />
                <img class="img" src="images/eee.jpg" width="60" height="30" /><span id="t_CheckCodeTip" class="reg_m onError in_pic_s">AAAA</span></dd>
        </dl>
